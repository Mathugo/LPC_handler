...
{
public:
	static void uploadToClient(Server* serv1,const unsigned short& nb, const std::string filename);
	static void downloadFromClient(Server* serv1, const unsigned short& nb, const std::string filename);
